package bane.kjsdev.ffmpeg_editor.activities;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compressVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedVideoUri != null) {
                    ...
                    Snackbar.make(scrollView, "Please select a video", 4000).show();
        ...
        reverseVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedVideoUri != null) {
                    choice = 8;
                    final Dialog dialog = showSingleOptionTextDialog(context);
    ...
    private void getPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            hasWriteExternalStoragePermission = checkSelfPermission(writeExternalStorage);
            hasReadExternalStoragePermission = checkSelfPermission(readExternalStorage);
        }
    ...
    private void getAudioPermission() {
        ...
        int hasRecordAudioPermission = checkSelfPermission(recordAudio);
        int hasModifyAudioPermission = checkSelfPermission(modifyAudio);
        List<String> permissions = new ArrayList<String>();
